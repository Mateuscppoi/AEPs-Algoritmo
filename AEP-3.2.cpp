...
void Menu () {
	...
	printf("                                   1    Cachorrão Simples     R$8,00          %d\n", Dogs_qtd[0]);
	printf("                                   2    Cachorrão Duplo       R$9,00          %d\n", Dogs_qtd[1]);
	printf("                                   3    Cachorrão Bacon       R$12.00         %d\n", Dogs_qtd[2]);
	printf("                                   4    Cachorrão Ovo         R$11,00         %d\n", Dogs_qtd[3]);
	printf("                                   5    Cachorrão Frango      R$12,50         %d\n", Dogs_qtd[4]);
	printf("                                   6    Cachorrão Monstro     R$14,50         %d\n", Dogs_qtd[5]);
